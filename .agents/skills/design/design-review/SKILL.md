...
- 問題発見 → 修正 → 再レビュー
- 最大 3 回まで
- 3 回リトライ後も FAIL なら `BLOCKED` としてユーザー判断を仰ぐ
...
- PASS 後に `phase_approvals.design_review = "approved"` を設定

## Do Not

- ブラウザプレビューなしに PASS を宣言
- 4 回以上の自動修正ループ
